...
public class TextLine implements Serializable {
    ...
    public TextLine(Integer lineId) {
        this.lineId = lineId;
    }
    ...
    public FileStatistics getTextId() {
        return textId;
    }

    public void setTextId(FileStatistics textId) {
        this.textId = textId;
    }
    ...
    public boolean equals(Object object) {
        ...
        TextLine other = (TextLine) object;
